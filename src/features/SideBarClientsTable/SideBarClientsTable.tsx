...
import SideBarClientsTableNewForm from "./SideBarClientsTableNewForm.tsx";
import SideBarClientsTableEditForm from "./SideBarClientsTableEditForm.tsx";
import type {ClientFormValues} from "./components/SideBarClientsTableForm.tsx";
...
const columns = (onEdit: (record: Client) => void, onDelete: (key: string) => void) => [
    ...
    { title: "Баллы", dataIndex: "points" },
    {
        ...
        render: (_value: unknown, record: Client) => (
            <>
                ...
                <Popconfirm title="Удалить клиента?" onConfirm={() => onDelete(record.key)}>
