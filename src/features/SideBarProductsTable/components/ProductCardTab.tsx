...
import { Descriptions, Image, Row, Col, Typography, Input, Button } from "antd";
    ...
    filesArray.forEach((file) => {
      ...
      reader.onload = () => {
        if (reader.result && typeof reader.result === "string") {
          setImages((prev: any) => [...prev, reader.result as string]);
        }
      };
      ...
      <Col span={7}>
        ...
        <Descriptions bordered column={1}>
          ...
          <Descriptions.Item label="Wildberries:">
            <Input
              value={wildberries}
              onChange={(e) => setWildberries(e.target.value)}
            />
          </Descriptions.Item>
          <Descriptions.Item label="Авито 906:">
            <Input
              value={avito906}
              onChange={(e) => setAvito906(e.target.value)}
            />
          </Descriptions.Item>
          <Descriptions.Item label="Авито 901:">
            <Input
              value={avito901}
              onChange={(e) => setAvito901(e.target.value)}
            />
          </Descriptions.Item>
          <Descriptions.Item label="Яндекс Маркет:">
            <Input
              value={yandexMarket}
              onChange={(e) => setYandexMarket(e.target.value)}
            />
          </Descriptions.Item>
          ...
          <Descriptions.Item label="Номер производителя:">
            <Input
              value={manufacturerNumber2}
              onChange={(e) => setManufacturerNumber2(e.target.value)}
            />
          </Descriptions.Item>
          <Descriptions.Item label="Габариты:">
            <Input
        ...
        <Descriptions bordered column={1}>
          <Descriptions.Item label="Производитель, импортер (контрагент):">
            <Input
              ...
              onChange={(e) => setProducerImporter(e.target.value)}
            />
          </Descriptions.Item>
          <Descriptions.Item label="Производитель(бренд):">
            <Input
              value={producerBrand}
              onChange={(e) => setProducerBrand(e.target.value)}
            />
          </Descriptions.Item>
      ...
      <Col span={6}>
        ...
        <Descriptions bordered column={1}>
          ...
          <Descriptions.Item label="Вид номенклатуры:">
            <Input
              ...
              onChange={(e) => setNomenclatureType(e.target.value)}
            />
          </Descriptions.Item>
          <Descriptions.Item label="Тип номенклатуры:">
            <Input
              value={nomenclatureKind}
              onChange={(e) => setNomenclatureKind(e.target.value)}
            />
          </Descriptions.Item>
        ...
        <Descriptions bordered column={1}>
          <Descriptions.Item label="Упаковки:">
            <Input
              value={packageUse}
              onChange={(e) => setPackageUse(e.target.value)}
            />
          </Descriptions.Item>
          ...
          <Descriptions.Item label="Вес">
            <Input
              value={weightMeas}
              onChange={(e) => setWeightMeas(e.target.value)}
            />
          </Descriptions.Item>
        ...
        <Descriptions bordered column={1}>
          <Descriptions.Item label="Подакцизный товар:">
            <Checkbox
              checked={isExciseProduct}
              onChange={(e) => setIsExciseProduct(e.target.checked)}
            />
          </Descriptions.Item>
        </Descriptions>
        ...
        <Descriptions bordered column={1}>
          <Descriptions.Item label="Код по КВПД:">
            <Input
              value={kvpdCode}
              onChange={(e) => setKvpdCode(e.target.value)}
            />
          </Descriptions.Item>
        </Descriptions>
      </Col>
